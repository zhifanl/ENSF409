...
import org.junit.Test;
 public class StringProcessorTest{
    ...
    @Test(expected=IllegalArgumentException.class)
    public void testidProcessingsingNorma111(){
       String input="Zhifan---Li";
       StringProcessor processor=new StringProcessor(input);
       String firstName="Zhifan";
       String lastName="Li";
   ...
   @Test(expected=IllegalArgumentException.class)
   public void testidProcessingsingNormal222(){
      String input="Zhifan  Li";
      StringProcessor processor=new StringProcessor(input);
      String firstName="Zhifan";
      String lastName="Li";
  ...
  @Test(expected=IllegalArgumentException.class)
  public void testidProcessingsingNormal333(){
     String input="Zhifan .Li";
     StringProcessor processor=new StringProcessor(input);
     String firstName="Zhifan";
     String lastName="Li";
 ...
 @Test(expected=IllegalArgumentException.class)
 public void testidProcessingsingNormal444(){
    String input="Zhifan...Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
...
@Test(expected=IllegalArgumentException.class)
public void testidProcessingsingNormal555(){
   String input="Zhifan''Li";
   StringProcessor processor=new StringProcessor(input);
   String firstName="Zhifan";
   String lastName="Li";
...
@Test(expected=IllegalArgumentException.class)
public void testidProcessingsingNormal666(){
   String input="Zhifan -Li";
   StringProcessor processor=new StringProcessor(input);
   String firstName="Zhifan";
   String lastName="Li";
...
@Test(expected=IllegalArgumentException.class)
public void testidProcessingsingNormal777(){
   String input="Zhifan 'Li";
   StringProcessor processor=new StringProcessor(input);
...
@Test(expected=IllegalArgumentException.class)
public void testidProcessingsingNormal7777(){
   String input="Zhifan-'Li";
   StringProcessor processor=new StringProcessor(input);
   String firstName="Zhifan";
   String lastName="Li";
...
@Test(expected=IllegalArgumentException.class)
public void testidProcessingsingNormal77777(){
   String input="Zhifan- Li";
   StringProcessor processor=new StringProcessor(input);
   String firstName="Zhifan";
   String lastName="Li";
...
public void testidProcessingsingNormal777778(){
    String input="Zhifan-.Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal7777788(){
    String input="Zhifan. Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal77777888(){
    String input="Zhifan.'Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal777778889(){
    String input="Zhifan.-Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal7777788890000(){
    String input="Zhifan---Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal7777788899(){
    String input="Zhifan' Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal77777888999(){
    String input="Zhifan'.Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal777778889990(){
    String input="Zhifan'-Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
 ...
 public void testidProcessingsingNormal7777788899900(){
    String input="Zhifan' Li";
    StringProcessor processor=new StringProcessor(input);
    String firstName="Zhifan";
    String lastName="Li";
...
public void testidProcessingsing2(){
   ...
   @Test(expected=IllegalArgumentException.class)
   public void testidProcessingsingWrongName2(){
       String input="Zhifan Li";
       StringProcessor processor=new StringProcessor(input);
       String firstName="'Ahifan";
      String lastName="Abc";
      String pet="M";
      int year=2020;
      String result=StringProcessor.idProcessing(firstName,lastName,pet,year);
  ...
  @Test(expected=IllegalArgumentException.class)
  public void testidProcessingsingWrongName3(){
      String input="Zhifan Li";
      StringProcessor processor=new StringProcessor(input);
      String firstName="'Ahifan";
     String lastName="Ab";
 ...
 @Test(expected=IllegalArgumentException.class)
  public void testidProcessingsingWrongName4(){
      String input="Zhifan Li";
      StringProcessor processor=new StringProcessor(input);
      String firstName="'A-";
     String lastName="Ab";
