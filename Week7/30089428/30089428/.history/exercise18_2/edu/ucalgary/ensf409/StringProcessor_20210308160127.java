    ...
    public static String idProcessing(String firstName, String lastName, String petName, int year) {
        ...
        for(int i=0;i<firstName.length();i++){
            if(!Character.isLetter(firstName.charAt(i))){
                if(firstName.charAt(i)!='\''&&firstName.charAt(i)!='-'&&firstName.charAt(i)!=' '&&firstName.charAt(i)!='.'){
                    throw new IllegalArgumentException();
        ...
        for(int i=0;i<lastName.length();i++){
            if(!Character.isLetter(lastName.charAt(i))){
                if(lastName.charAt(i)!='\''&&lastName.charAt(i)!='-'&&lastName.charAt(i)!=' '&&lastName.charAt(i)!='.'){
                    throw new IllegalArgumentException();
        ...
        for(int i=0;i<petName.length();i++){
            if(!Character.isLetter(petName.charAt(i))){
                if(petName.charAt(i)!='\''&&petName.charAt(i)!='-'&&petName.charAt(i)!=' '&&petName.charAt(i)!='.'){
                    throw new IllegalArgumentException();
       ...
       if(firstName.contains("--")||firstName.contains("  ")||firstName.contains("- ")||firstName.contains("-.")||firstName.contains("-'")||firstName.contains(" -")||firstName.contains(" .")||firstName.contains(" '")||firstName.contains(".-")||firstName.contains(". ")||firstName.contains("..")||firstName.contains(".'")||firstName.contains("'-")||firstName.contains("' ")||firstName.contains("'.")||firstName.contains("'-")){
            throw new IllegalArgumentException();
       }
       if(lastName.contains("--")||lastName.contains("  ")||lastName.contains("- ")||lastName.contains("-.")||lastName.contains("-'")||lastName.contains(" -")||lastName.contains(" .")||lastName.contains(" '")||lastName.contains(".-")||lastName.contains(". ")||lastName.contains("..")||lastName.contains(".'")||lastName.contains("'-")||lastName.contains("' ")||lastName.contains("'.")||lastName.contains("'-")){
        throw new IllegalArgumentException();
        }
        if(petName.contains("--")||petName.contains("  ")||petName.contains("- ")||petName.contains("-.")||petName.contains("-'")||petName.contains(" -")||petName.contains(" .")||petName.contains(" '")||petName.contains(".-")||petName.contains(". ")||petName.contains("..")||petName.contains(".'")||petName.contains("'-")||petName.contains("' ")||petName.contains("'.")||petName.contains("'-")){
            throw new IllegalArgumentException();
            }
