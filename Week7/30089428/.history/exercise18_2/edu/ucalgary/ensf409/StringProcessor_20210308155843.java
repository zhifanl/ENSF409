...
public class StringProcessor{
    ...
    public static String idProcessing(String firstName, String lastName, String petName, int year) {
       ...
       if(firstName.contains("--")||firstName.contains("  ")||firstName.contains("- ")||firstName.contains("-.")||firstName.contains("-'")||firstName.contains(" -")||firstName.contains(" .")||firstName.contains(" '")||firstName.contains(".-")||firstName.contains(". ")||firstName.contains("..")||firstName.contains(".'")||firstName.contains("'-")||firstName.contains("' ")||)
